...
class _ChartState extends ScatterActionState<Chart>
  ...
  void _initScatterData(int count, double range) async {
    ...
    imgs[0] = await ImageLoader.loadImage('assets/images/star.png');
    imgs[1] = await ImageLoader.loadImage('assets/images/add.png');
    imgs[2] = await ImageLoader.loadImage('assets/images/close.png');
